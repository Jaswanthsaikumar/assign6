...
public class BlockPostApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Location loc2 = new Location("delhi");

		Users user1 = new Users("jaswanth", "kumar", loc1, "kumar@gmail.com");
		Users user2 = new Users("pavan", "a", loc1, "pavan@gmail.com");
		Users user3 = new Users("mani", "m", loc2, "mani@gmail.com");
